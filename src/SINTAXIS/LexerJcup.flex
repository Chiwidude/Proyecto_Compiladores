...
"FILANAME" {return new Symbol (sym.FILENAME,yycolumn,yyline, yytext());}
"NAME" {return new Symbol (sym.NAME,yycolumn,yyline, yytext());}
";" {Empty}* "GO" {return new Symbol (sym.PGO,yycolumn,yyline, yytext());}
...
({Digito})+ "." ({Digito}*) ([E|e] [+|-]? {Digito}+)* {return new Symbol (sym.CONSTANTE_DECIMAL,yycolumn,yyline, yytext());}
...
/*                                                               ERROR                                                            */
  ...
  ("/*") {String} {return new Symbol (sym.ERROR,yycolumn,yyline, yytext());}
  ("'") {String} {return new Symbol (sym.ERROR,yycolumn,yyline, yytext());}